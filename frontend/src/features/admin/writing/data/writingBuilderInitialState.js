...
export const INITIAL_WRITING_TEST = {
  ...
  parts: {
    1: { context: 'You want to join a language club. You have 5 messages from a member of the club. Write short answers (1–5 words) to each message.', questions: ['Please tell us about the last book you read.', 'What kind of music do you listen to most?', '', '', ''] },
    ...
    3: { context: 'You are a member of the language club. You are talking to other members in the club chat room.', messages: ['Hi! I am a new member. How long have you been in the club and why did you join?', 'Welcome! What is your favourite activity to do here?', ''] },
    4: { context: 'The club has announced an important change to next month’s programme.', informalPrompt: 'Write an email to a friend in the club. Explain how you feel and suggest what you can do together instead.', formalPrompt: 'Write an email to the club manager. Explain your concerns and ask for more information about the new arrangements.' },
  },
};
